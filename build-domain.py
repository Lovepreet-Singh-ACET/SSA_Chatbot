...
path = '/home/user/Desktop/Sabudh/ResearchProject/SSA_Chatbot/domain-grp'
yaml_list = []
...
domain_yml_file = open("/home/user/Desktop/Sabudh/ResearchProject/SSA_Chatbot/domain.yml","w+")
